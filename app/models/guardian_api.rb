...
class GuardianAPI
	...
	# def page_size_format
	# 	"page-size=#{@page_size}&"
	# end
	
	# def search_format
	# 	@search_format = "show-fields=trailText&#{page_size_format}#{from_date_format}#{to_date_format}#{current_page_format}#{order_by_format}q=#{@search_input_formatted}"
	# 	# show-blocks=all&
	# end

	# def from_date_format
	# 	# byebug
	# 	"from-date=#{@from_date}&"
	# end
	...
	# 	"order-by=#{@order_by}&"
	# end
	# attr_accessor :current_page_num, :page_size, :to_date, :from_date, :search_input
	...
	# 	@search_format = "#{@page_size}#{@current_page}#{@from_date}#{@to_date}#{@order_by}q=#{@search_input_formatted}"
	# end
	...
	# 	@current_page = "page=#{@current_page_num}&"
	# end
	...
	# 	# start date
	# 	@from_date = "from-date=#{:year}-#{:month}-#{:year}&"
	# end

	# def to_date(day:, month:, year:)
	# 	# end date
	# 	@to_date = "to-date=#{:year}-#{:month}-#{:year}&"
	# end
